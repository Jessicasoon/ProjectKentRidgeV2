  ...
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
	...
	if($totalRows_getOption > 0){
		...
		<div id="cq<?php echo $question; ?>o<?php echo $i; ?>">
                ...
                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                <tr>
      <th width="25" scope="row"><input type="hidden" name="uq<?php echo $question; ?>o<?php echo $i; ?>" id="uq<?php echo $question; ?>o<?php echo $i; ?>" value="<?php echo $row_getOption['option_id']; ?>" /> <!--line 156 modified to get fk_question_id-->
      <a href="javascript:;" onclick="QuizQuestionMulti.removeOption(<?php echo $row_getOption['fk_question_id']; ?>, <?php echo $question; ?>, <?php echo $i; ?>);"><img src="img/delete.png" width="16" height="16" border="0" align="absmiddle" title="Remove" /></a></th>
      ...
      <td width="100"><select name="q<?php echo $question; ?>o<?php echo $i; ?>w<?php echo $j; ?>" id="q<?php echo $question; ?>o<?php echo $i; ?>w<?php echo $j; ?>">
		  ...
		  <option value="4"<?php if(4 == $row_getOption['option_weightage']){ echo 'selected = "selected"'; }; ?>>&nbsp;&nbsp;&nbsp;&nbsp;4&nbsp;&nbsp;&nbsp;</option>
