...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
  <tr>
    <th width="25" scope="row"><a href="javascript:;" onclick="QuizQuestionTest.remove(<?php echo $question; ?>);"><img src="img/delete.png" alt="" width="16" height="16" border="0" align="absmiddle" title="Remove" /></a></th>
...
<div id="optionContainer_<?php echo $question; ?>">
  ...
  <table border="0" align="center" cellpadding="5" cellspacing="0">
    <tr>
      <th valign="top" scope="row"><input type="button" name="addOptionBtn<?php echo $question; ?>" id="addOptionBtn<?php echo $question; ?>" value="Add new option" onClick="QuizQuestionTest.addOption(<?php echo $question; ?>)" /></th>
    </tr>
    <tr>
...
<!--      <th width="150" align="center">Contributes to</th>
    ...
    <tr>
      ...
      <td><span id="sprytextfield-q<?php echo $question; ?>o0" class="sprytextfield">
        ...
        <span class="textfieldRequiredMsg">Enter a value for this option!</span></span></td>
		  <td width ="150"><input type="checkbox" name="q<?php echo $question; ?>r0" value="1"> Correct Answer</td>
...
<!--      <td width="150"><select name="q<?php echo $question; ?>r0" class="optionSelect" id="q<?php echo $question; ?>r0">
    ...
    <tr>
      ...
      <td><span id="sprytextfield-q<?php echo $question; ?>o1" class="sprytextfield">
        ...
        <span class="textfieldRequiredMsg">Enter a value for this option!</span></span></td>
		  <td width ="150"><input type="checkbox" name="q<?php echo $question; ?>r1" value="1"> Correct Answer</td>
