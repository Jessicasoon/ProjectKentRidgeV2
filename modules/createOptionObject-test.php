...
if(isset($_GET['delete'])){
	...
	$member = new Member();
	if(!$quiz->removeOptionTest($_GET['option'], $member->id)){
...
$querySQL = "SELECT result_id, result_title FROM q_results_test WHERE fk_quiz_id = ".GetSQLValueString($quiz, "int");
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
  <tr>
    <th width="25" scope="row"><a href="javascript:;" onclick="QuizQuestionTest.removeOption(<?php echo $question; ?>, <?php echo $option; ?>);"><img src="img/delete.png" width="16" height="16" border="0" align="absmiddle" title="Remove" /></a></th>
