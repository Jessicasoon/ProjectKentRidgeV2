...
?>
<?php if($mode == "simple" || $mode == "accurate"){ ?>
  <form action="../modules/modifyQuizEngine.php?step=3" method="post" enctype="multipart/form-data" name="createQuiz" id="createQuiz" onsubmit="return submitCheckMulti(Spry.Widget.Form.validate(this));">
<input type="hidden" name="id" value="<?php echo $quiz->quiz_id; ?>" />
...
<?php }else{ ?>
  <form action="../modules/modifyQuizEngine.php?step=3" method="post" enctype="multipart/form-data" name="createQuiz" id="createQuiz" onsubmit="return submitCheckTest(Spry.Widget.Form.validate(this));">
<input type="hidden" name="id" value="<?php echo $quiz->quiz_id; ?>" />
<input type="hidden" name="optionCounts" id="optionCounts" value="" />
<input type="hidden" name="questionCount" id="questionCount" value="" />
<div id="createQuestionContainer"></div>
