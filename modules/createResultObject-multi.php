...
<?php //added -multi to necessary - LIEN
...
if(isset($_GET['load'])){ //user is modifying quiz
	...
	$query = sprintf("SELECT result_id, result_title, result_description, result_picture FROM q_results_multi WHERE fk_quiz_id = %d", GetSQLValueString($_GET['id'], "int"));
...
<table width="95%" border="0" align="center" cellpadding="5" cellspacing="0">
  <tr>
    <th colspan="2" valign="top" scope="row"><a href="javascript:;" onclick="QuizResultMulti.remove(<?php echo $result; ?>);"><img src="img/delete.png" alt="" width="16" height="16" border="0" align="absmiddle" title="Remove" /></a> Result</th>
  </tr>
  <tr>
...
<?php 	$result++;
	...
	$member = new Member();
	if(!$quiz->removeResultMulti($_GET['result'], $member->id)){
