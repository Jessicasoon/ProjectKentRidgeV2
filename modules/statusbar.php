...
<div id="statusbar-container">
  <div id="statusbar"> <a href="index.php" id="statusbar-logo" title="Quizroo"><span>Quizroo</span></a>
    ...
    <div id="statusbar-game">
      <div id="statusbar-scores" class="statusbar-element">
        ...
        <div id="statusbar-quiztaker">
          <div id="statusbar-quiztaker-logo" title="Quiz Creator and Taker"></div>
    ...
    <div id="statusbar-divider"></div>
    <div id="statusbar-quiz" class="statusbar-text statusbar-element" title="Create, Manage or Browse quizzes">Create</div>
    <!--ADDED BY YL ON 22nd aug, topic button-->
	<div id="statusbar-divider"></div>
    <div id="statusbar-topics" class="statusbar-text statusbar-element" title="Browse available topics">Topics</div>
    <div id="statusbar-divider"></div>
