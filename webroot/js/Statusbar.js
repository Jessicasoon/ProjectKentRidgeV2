var Statusbar = {
	...
	displayInformation: function(option){
		 ...
		 */
			...
			//------------------ADDED BY YL ON 30aug, topics menu---------------------
		}else if(option=='statusbar-topics'){		
		$('#statusbar-info').addClass('statusbar-menu').html('');
			var topics = document.createElement('div');
			$('#statusbar-info').append(topics);
			$(topics).addClass('statusbar-menu-item').html(
				"<div class='statusbar-menu-topictitle'>General</div>"+
				"<div class='statusbar-menu-desc'>Everything under the sun!</div>"
			);
			$(topics).click(function(){
				goToURL('topics.php?topic=1');
				$(topics).css('background-color','#333');
			});	
			var topics2 = document.createElement('div');
			$('#statusbar-info').append(topics2);
			$(topics2).addClass('statusbar-menu-item').html(
				"<div class='statusbar-menu-topictitle'>Technology</div>"+
				"<div class='statusbar-menu-desc'>Discover interesting facts about technology and science!</div>"
			);
			$(topics2).click(function(){
				goToURL('topics.php?topic=2');
				$(topics2).css('background-color','#333');
			});	
			var topics3 = document.createElement('div');
			$('#statusbar-info').append(topics3);
			$(topics3).addClass('statusbar-menu-item').html(
				"<div class='statusbar-menu-topictitle'>Lifestyle</div>"+
				"<div class='statusbar-menu-desc'>Find out how to live a healthy lifestyle!</div>"
			);
			$(topics3).click(function(){
				goToURL('topics.php?topic=3');
				$(topics3).css('background-color','#333');
			});	
			var topics4 = document.createElement('div');
			$('#statusbar-info').append(topics4);
			$(topics4).addClass('statusbar-menu-item').html(
				"<div class='statusbar-menu-topictitle'>Politics</div>"+
				"<div class='statusbar-menu-desc'>Update your politics knowledge!</div>"
			);
			$(topics4).click(function(){
				goToURL('topics.php?topic=4');
				$(topics4).css('background-color','#333');
			});	
			var topics5 = document.createElement('div');
			$('#statusbar-info').append(topics5);
			$(topics5).addClass('statusbar-menu-item').html(
				"<div class='statusbar-menu-topictitle'>Animals</div>"+
				"<div class='statusbar-menu-desc'>Learn interesting facts about animals!</div>"
			);
			$(topics5).click(function(){
				goToURL('topics.php?topic=5');
				$(topics5).css('background-color','#333');
			});	
			var topics6 = document.createElement('div');
			$('#statusbar-info').append(topics6);
			$(topics6).addClass('statusbar-menu-item').html(
				"<div class='statusbar-menu-topictitle'>Movies</div>"+
				"<div class='statusbar-menu-desc'>How much do you know about your favourite movies?</div>"
			);
			$(topics6).click(function(){
				goToURL('topics.php?topic=6');
				$(topics6).css('background-color','#333');
			});	
			var topics7 = document.createElement('div');
			$('#statusbar-info').append(topics7);
			$(topics7).addClass('statusbar-menu-item').html(
				"<div class='statusbar-menu-topictitle'>Social</div>"+
				"<div class='statusbar-menu-desc'>What is the current trend?</div>"
			);
			$(topics7).click(function(){
				goToURL('topics.php?topic=7');
				$(topics7).css('background-color','#333');
			});	
			var topics8 = document.createElement('div');
			$('#statusbar-info').append(topics8);
			$(topics8).addClass('statusbar-menu-item').html(
				"<div class='statusbar-menu-topictitle'>Entertainment</div>"+
				"<div class='statusbar-menu-desc'>How much do you know about your favourite idols?</div>"
			);
			$(topics8).click(function(){
				goToURL('topics.php?topic=8');
				$(topics8).css('background-color','#333');
			});				
	...
	/*
	 * Retrieves topics from database and stores it locally. Updates ui accordingly.
	 */
/*	getTopics: function(member_id){
		$.getJSON(Statusbar.pathToSrc+'updateStatus.php/',{method:'topics', member:member_id},function(data){
			var topics = data['getTopics'];
			var rowTopics = data['row_getTopics'];
